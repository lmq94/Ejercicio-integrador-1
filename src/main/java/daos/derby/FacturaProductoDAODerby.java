...
public class FacturaProductoDAODerby implements Factura_ProductoDAO {
    ...
    private static FacturaProductoDAODerby instancia;

    private FacturaProductoDAODerby(Connection conexion){
        this.conexion = conexion;
    }

    public static FacturaProductoDAODerby getInstancia(Connection conexion) {
        if (instancia == null) {
            instancia = new FacturaProductoDAODerby(conexion);
        }
        return instancia;
    }
